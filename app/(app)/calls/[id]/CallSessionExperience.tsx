...
export default function CallSessionExperience({
  ...
  const emitModeTelemetry = useCallback(
    (nextMode: CallSessionMode) => {
      ...
      console.log("[calls-session-call-mode-select]", {
        ...
        primaryCtaLabel: nextModel.instruction.primaryCta?.label,
        ...nextModel.instruction.telemetry,
      });
    },
  ...
  useEffect(() => {
    ...
    console.log("[calls-session-primary-cta-visible]", {
      ...
      primaryCtaLabel: activeModel.instruction.primaryCta?.label,
      ...activeModel.instruction.telemetry,
    });
  }, [
    activeModel.ctaReasonCode,
    activeModel.primaryCta.kind,
    activeModel.instruction.primaryCta?.label,
    activeModel.instruction,
    callId,
    mode,
    workspaceId,
  ]);
